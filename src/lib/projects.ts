...
export const projects: Project[] = [
  {
    ...
    year: "2026",
    status: "wip",
    description: "A personal assistant that aggregates data like health, notes, and calendar to facilitate your day.",
    blurb: "custom check-ins personalized with your data",
